...
if (isset($_POST['submit'])) {
	...
	if ($payment_type == 'payu') {
		...
		$MERCHANT_KEY = "iJkLuA";
		// $SALT = "eCwWELxi";
		$SALT = "B2E6pIPusT8vYTDcuwYpnMXQiQfmkjlF";
		$hash_string = '';
		$PAYU_BASE_URL = "https://secure.payu.in";
		// $PAYU_BASE_URL = "https://pmny.in/TIBYS5lnswWT";
...
<div class="ht__bradcaump__area"
	style="background: rgba(0, 0, 0, 0) url(nav-side.jpeg) no-repeat scroll center center / cover ;">
							...
							<div class="accordion__body">
								<div class="accordion__body__form">
									<div class="row">
										<div class="col-md-6">
											<div
												class="checkout-method__login">
												<form id="login-form"
													method="post">
													<h5
														class="checkout-method__title">
														Login
													</h5>
													<div
														class="single-input">
													...
													<div
														class="form-output login_msg">
														<p
															class="form-messege field_error">
														</p>
													</div>
												</form>
											</div>
