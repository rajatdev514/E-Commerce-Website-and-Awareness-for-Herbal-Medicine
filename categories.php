...
<div class="ht__bradcaump__area"
	style="background: rgba(0, 0, 0, 0) url(media/nn.jpeg) no-repeat  scroll center center  / cover;">
				...
				<div class="col-xs-12">
					<div class="bradcaump__inner">
						<nav class="bradcaump-inner">
							<a class="breadcrumb-item" href="index.php">
								<B>
									Home
								</B>
							</a>
						...
						<div class="htc__select__option">
							<select class="ht__select"
								...
								<option value="price_low" <?php echo $price_low_selected
									?>>Sort by price
									low to hight</option>
								<option value="price_high" <?php echo
									$price_high_selected ?>>Sort by price
									high to low</option>
								<option value="new" <?php echo $new_selected ?>>Sort by
									new first</option>
								<option value="old" <?php echo $old_selected ?>>Sort by
									old first</option>
							</select>
						</div>
								...
								<div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
									<div class="category">
										<div class="ht__cat__thumb">
											<a
												href="product.php?id=<?php echo $list['id'] ?>">
										...
										<div class="fr__product__inner">
											<h4> <a href="product-details.html">
												...
												<!-- <h4><a href="product.php?id="><?php echo $list['name'] ?></a> -->
											</h4>
