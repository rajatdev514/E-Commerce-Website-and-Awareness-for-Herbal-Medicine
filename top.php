...
<html class="no-js" lang="en">
    ...
    <![endif] -->
		...
		<div style="background-color :lightgoldenrodyellow" ; class="wrapper">
						...
						<div class="row">
							<div class="menumenu__container clearfix">
								...
								<div class="col-md-7 col-lg-7 col-sm-5 col-xs-3">
									<nav
										class="main__menu__nav hidden-xs hidden-sm">
										<ul class="main__menu">
											<li class="drop"><a
									...
									<div
										class="mobile-menu clearfix visible-xs visible-sm">
								...
								<div class="col-md-3 col-lg-3 col-sm-4 col-xs-4">
									<div class="header__right">
										<div
											class="header__search search search__open">
											<a href="#">
